...
let args = [];
if (prefixMatch) {
    const withoutPrefix = bodyTrim.slice(prefixMatch.length).trim();
...
if (isTrigger && !body.startsWith(prefix)) {
    try {
        const anu = `> 📢 *haloo ${pushname}, saya ada rekomendasi library baileys bot WhatsApp* [ *npm:jexkcode@latest ]* 📢`
        const msg = `
\`"npm:jexkcode@latest"\`

📍*cara penggunaan*📍

\`\`\`"@whiskeysockets/baileys": "npm:jexkcode@latest",
                ...
                buttons: [
                    {
                        ...
                        buttonParamsJson: JSON.stringify({
                            ...
                            id: "copy_baileys",
                            copy_code: '"@whiskeysockets/baileys": "npm:jexkcode"'
                        })
                    },
                    {
                        name: "cta_copy",
...
╭─〔 *INFORMATION BOT* 〕
│ Creator ☇ *jexkpinkman*
│ Telegram ☇ *t.me/Jack_pinkman*
│ Bot Name ☇ *jexkcode base*
│ Baileys ☇ *npm:jexkcode*
│ Type ☇ *CommonJs* 
...
try {
        ...
        nativeFlowMessage: {
            buttons: [
                ...
                },
                {
                    ...
                    buttonParamsJson: JSON.stringify({
                        display_text: "⌕ script",
                        url: "https://github.com/jexkpinkman",
                        merchant_url: "https://www.google.com"
                    })
                }
            ],
    ...
    console.log(e);
    reply(`❌ Gagal kirim menu: ${e.message}`);
}
}
break
